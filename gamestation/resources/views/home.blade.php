<x-app-layout>
        ...
        <div class="px-0 pt-6">
            <div class="gs-card gs-hero-banner gs-hero-banner--full">
                ...
                <div class="gs-hero-overlay">
                    ...
                    <h1 class="gs-hero-title">Hệ thống bán lẻ game và phụ kiện chính hãng</h1>
                    <p class="gs-hero-subtitle">Combo PS5, PS4, Nintendo Switch và phụ kiện hot cập nhật mỗi ngày.</p>
                    <div class="mt-4 flex flex-wrap gap-3">
                        <a href="{{ route('products.index') }}" class="gs-button">Mua ngay</a>
                        <a href="{{ route('contact', [
                            'subject' => 'Tư vấn nhanh về sản phẩm GameStation',
                            'message' => 'Xin chào, tôi muốn được tư vấn nhanh về sản phẩm phù hợp nhu cầu của tôi.'
                        ]) }}" class="gs-button gs-button--ghost">Tư vấn nhanh</a>
                    </div>
                </div>
    ...
    <section class="gs-section">
        ...
        <div class="gs-section-header">
            <div class="gs-title">
                <div>
                    <p class="gs-section-kicker">Sản phẩm</p>
                    <h2 class="gs-section-title">Sản phẩm mới</h2>
                </div>
            </div>
            <a href="{{ route('products.index') }}" class="gs-link">Xem thêm</a>
        </div>
        ...
        <div class="gs-slider gs-slider--products" data-slider data-interval="3000">
            <div class="gs-slider-track" data-slider-track>
                ...
                @empty
                    <div class="gs-slide">
                        <div class="gs-card p-6 text-slate-600">Đang cập nhật sản phẩm.</div>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <section class="gs-section">
        ...
        <div class="gs-section-header">
            <div class="gs-title">
                <div>
                    <p class="gs-section-kicker">Nổi bật</p>
                    <h2 class="gs-section-title">Sản phẩm nổi bật</h2>
                </div>
            </div>
            <a href="{{ route('products.index') }}" class="gs-link">Xem thêm</a>
        </div>
    ...
    <section class="gs-section">
        ...
        <div class="gs-section-header">
            ...
            <a href="{{ route('products.index', ['category' => 'ps4']) }}" class="gs-link">Xem thêm</a>
        </div>
        <div class="mt-6 gs-product-slider-shell">
        <div class="gs-slider gs-slider--products" data-slider data-interval="3000">
            <div class="gs-slider-track" data-slider-track>
    ...
    <section class="gs-section">
        ...
        <div class="gs-section-header">
            ...
            <a href="{{ route('products.index', ['category' => 'ps5']) }}" class="gs-link">Xem thêm</a>
        </div>
        <div class="mt-6 gs-product-slider-shell">
        <div class="gs-slider gs-slider--products" data-slider data-interval="3000">
            <div class="gs-slider-track" data-slider-track>
    ...
    <section class="gs-section">
        ...
        <div class="gs-section-header">
            ...
            <a href="{{ route('products.index', ['category' => 'switch']) }}" class="gs-link">Xem thêm</a>
        </div>
        <div class="mt-6 gs-product-slider-shell">
        <div class="gs-slider gs-slider--products" data-slider data-interval="3000">
            <div class="gs-slider-track" data-slider-track>
    ...
    <section class="gs-section">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="gs-section-header">
                <div class="gs-title">
                    <div>
                        <p class="gs-section-kicker">Tin tức</p>
                        <h2 class="gs-section-title">Tin tức & Bài viết</h2>
                    </div>
                </div>
                <a href="{{ route('articles.index') }}" class="gs-link">Xem thêm</a>
            </div>
            <div class="mt-6 gs-slider gs-slider--articles" data-slider data-interval="5000">
                <div class="gs-slider-track" data-slider-track>
                    ...
                    @empty
                    <div class="gs-slide">
                        <div class="gs-card p-6 text-center text-slate-600">Chưa có bài viết nào được xuất bản.</div>
                    </div>
                    @endforelse
                </div>
