...
class ProductController extends Controller
{
    ...
    public function update(Request $request, Product $product)
    {
        ...
        if ($page) {
            return redirect()->route('admin.products.index', ['page' => $page])->with('success', 'Sản phẩm đã được cập nhật.');
        }
    ...
    public function destroy(Product $product)
    {
        ...
        $page = request()->input('page');
        if ($page) {
            return redirect()->route('admin.products.index', ['page' => $page])->with('success', 'Sản phẩm đã được xóa.');
        }
