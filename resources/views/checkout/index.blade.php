                ...
                <div class="gs-card p-6">
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="payment_method" class="mt-1 w-full rounded-xl border border-slate-300 px-4 py-2 bg-white focus:border-sky-500 focus:ring-sky-500" required>
                                <option value="">-- Chọn phương thức --</option>
                                <option value="cod" {{ old('payment_method') == 'cod' ? 'selected' : '' }}>Thanh toán khi nhận hàng (COD)</option>
                                <option value="card" {{ old('payment_method') == 'card' ? 'selected' : '' }}>Thẻ nội địa</option>
                            </select>
                ...
                <div class="gs-card p-6">
                    ...
                    <div class="mt-4 space-y-2 text-sm text-slate-600">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span id="shipping-fee-val" class="font-semibold text-slate-900">{{ number_format($shippingFee, 0, ',', '.') }}đ</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between border-t border-slate-200 pt-2">
                            ...
                            <span id="total-val" class="text-lg font-bold text-slate-900">{{ number_format($total, 0, ',', '.') }}đ</span>
                        </div>
                    </div>
                    @if ($coupon)
                    ...
                    @endif
                    <p class="mt-1 text-xs text-slate-500">Địa chỉ shop: {{ config('shipping.shop_address') }}</p>
                </div>
            </div>
            @endif
        </div>
