<x-app-layout>
                ...
                <div class="gs-card p-8 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
                    ...
                    <ul class="mt-2 space-y-2 text-xs text-slate-300 grid grid-cols-2 gap-x-4">
                        <li class="flex items-center gap-2">
                            ...
                            Mã giảm giá 500k (đơn từ 2M)
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="w-2 h-2 rounded-full bg-indigo-500"></span>
                            Mã giảm giá 300k (đơn từ 1.8M)
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="w-2 h-2 rounded-full bg-pink-500"></span>
                            Mã giảm giá 200k (đơn từ 1.5M)
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="w-2 h-2 rounded-full bg-violet-500"></span>
                            Mã giảm giá 150k (đơn từ 1.2M)
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="w-2 h-2 rounded-full bg-sky-500"></span>
                            Mã giảm giá 100k (đơn từ 1M)
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="w-2 h-2 rounded-full bg-emerald-500"></span>
                            Mã giảm giá 50k (đơn từ 500k)
                        </li>
                        <li class="flex items-center gap-2">
    ...
    <script>
        ...
        const winSound = new Audio('https://tiengdong.com/wp-content/uploads/Am-thanh-may-man-tiktok-www_tiengdong_com.mp3');
